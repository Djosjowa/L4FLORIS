...
optimStruct.iterations      = 10000;                            % Optimization iterations  [-]
...
optimStruct.stepYaw         = 2.5;                          % Step size yaw angles [rad]
optimStruct.minA            = 0;                            % Smallest axial induction factor
optimStruct.maxA            = 1/3;                         % Largest axial induction factor
optimStruct.initA           = 0.083;                          % Axial induction factor used for first iteration
optimStruct.stepA           = 0.01;                         % Step size for axial induction
optimStruct.windUncertainty = [-12:4:12];                   % Additional wind disturbance range (symmetric)
optimStruct.eps             = 0.03;                         % Explortation rate
