...
optimStruct.iterations      = 200;                          % Optimization iterations  [-]
...
% Run optimization
[a_opt,J_Pws_opt,J_DEL_opt,J_sum_opt] = optimizeL4FLORIS(modelStruct,turbType,siteStruct,optimStruct,DEL_table,Pref, Pbandwidth,plotResults);